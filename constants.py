...
# RAG設定系
# ==========================================
RAG_CHUNK_SIZE = 500              # テキストチャンクのサイズ
RAG_CHUNK_OVERLAP = 50            # チャンク間の重複サイズ
RAG_RETRIEVER_K = 5               # 取り出すドキュメント数
...
SYSTEM_PROMPT_INQUIRY = """
    ...
    8. 複数の該当者や項目がある場合は、以下の文脈に含まれる情報を全て漏れなく一覧化して回答してください。表形式やリスト形式で見やすく整理してください。
